  ...
  useEffect(() => {
    const saveSession = async () => {
      if (score !== null && score > 0) {
        ...
        if (currentUser) {
          try {
            const session = await addSession(currentUser.id, "Technical Interview", score, timer);
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          {isAnalyzing && (
            <div className="text-center text-gray-600 my-4 animate-pulse">
              ⏳ Analyzing your technical interview performance...
            </div>
          )}
          ...
          {!isRecording && videoURL && (
            ...
            >
              Download Technical Interview Video
            </a>
          )}
          ...
          {score !== null && (
            <div className="bg-gray-50 rounded-lg p-6 text-center border-t mt-6">
              <h3 className="text-xl font-semibold mb-2">Technical Interview Score</h3>
              <div className="text-4xl font-bold text-purple-600 mb-4">{score}%</div>
              <div className="text-gray-600">
                <p className="mb-2">Technical Interview Tips:</p>
                <ul className="text-left max-w-md mx-auto list-disc list-inside text-sm">
                  ...
                  <li>Consider edge cases and optimization</li>
                </ul>
              </div>
            </div>
          )}
