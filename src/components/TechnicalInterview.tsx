...
function TechnicalInterview({ onClose }: TechnicalInterviewProps) {
  ...
  useEffect(() => {
    const loadQuestions = async () => {
      try {
        console.log('Loading technical questions...');
  ...
  const analyzeVideo = async (blob: Blob) => {
    ...
    formData.append("file", blob, "technical_interview.webm");
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex justify-between items-center">
          <h1 className="text-xl font-semibold text-gray-900">Technical Interview Practice</h1>
          ...
          {currentQuestion ? (
            <div className="flex-1 p-6 overflow-y-auto">
              ...
              <button
                ...
                className="flex items-center gap-2 text-purple-600 hover:text-purple-700 text-sm font-medium mb-4"
              >
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 mt-1">•</span>
                    <span>Explain your approach step by step</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 mt-1">•</span>
                    <span>Consider edge cases and optimization</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="p-6 overflow-y-auto">
            ...
            {isAnalyzing && (
              <div className="text-center text-gray-600 py-8 animate-pulse">
                ...
                <p>Analyzing your technical interview performance...</p>
              </div>
            )}
            ...
            {!isRecording && videoURL && (
              <div className="mb-6">
                <a
                  href={videoURL}
                  download="technical_interview.webm"
