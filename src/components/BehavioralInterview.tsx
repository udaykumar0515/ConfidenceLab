            ...
            <div className="flex-1 p-6 overflow-y-auto">
              ...
              <div className="mt-6 p-4 bg-orange-50 rounded-lg border border-orange-200">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-orange-500 mt-1">•</span>
                    <span>Be specific with examples and outcomes</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-orange-500 mt-1">•</span>
                    <span>Show your problem-solving skills</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-orange-500 mt-1">•</span>
                    <span>Demonstrate leadership and teamwork</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="p-6 overflow-y-auto">
            ...
            {isAnalyzing && (
              <div className="text-center text-gray-600 py-8 animate-pulse">
                ...
                <p>Analyzing your behavioral interview performance...</p>
              </div>
            )}
            ...
            {score !== null && (
              <div className="space-y-4">
                <div className="text-center p-6 bg-gradient-to-br from-green-50 to-orange-50 rounded-lg border border-green-200">
